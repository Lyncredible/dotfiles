# Generated by Powerlevel10k configuration wizard on 2025-03-20 at 17:42 PDT.
...
() {
  ...
  # SSH context (fallback: white on magenta).
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=$([ -x "$_wc" ] && "$_wc" --256 fg || echo 7)
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_BACKGROUND=$([ -x "$_wc" ] && "$_wc" --256 bg || echo 5)
  # Default context color (fallback: white on cyan).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=$([ -x "$_wc" ] && "$_wc" --256 fg || echo 7)
  typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=$([ -x "$_wc" ] && "$_wc" --256 bg || echo 14)

  # Context format when running with privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE="%n@${HOSTNAME_OVERRIDE:-%m}"
  # Context format when in SSH without privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE="%n@${HOSTNAME_OVERRIDE:-%m}"
  # Default context format (no privileges, no SSH): user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE="%n@${HOSTNAME_OVERRIDE:-%m}"
